...
Som ovan exempel visar används prefix-tillståndet tillsammans med \mono{IR} för
...
\item[\mono{dbus\_src}]
    Komponentens utdata som ska muxas till databussen.
\item[\mono{abus\_src}]
    Källan till adressbussen.
\item[\mono{rf\_daddr}]
