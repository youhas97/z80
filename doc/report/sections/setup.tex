...
processorn sätta igång och börja exekvera på adress \mono{0x8000}.
...
adress \mono{0x00000} eftersom miniräknarens ROM börjar på där. Hur miniräknarens
...
\item[\mono{trace\_enable}]
    ...
    sker ett avbrott och processorn hoppar till adress \mono{0x0038}.
