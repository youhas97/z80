...
\mono{NMI}-signal. Det här innebär även att IFF2 aldrig kommer skilja sig från
...
antingen öka eller minska \mono{X} eller \mono{Y} ett steg. Pekarens riktning
ställs också in med port \mono{10}.
