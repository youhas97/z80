...
\begin{itemize}
    ...
    \item \mono{F} - Registret som lagrar flaggorna. Under en ALU-instruktion
        laddas \mono{F} med flaggorna. Det finns inga flyttnings- eller
        räkneinstruktioner såsom \mono{ld} eller \mono{sub} som använder
        \mono{F}. \mono{F} ändras endast indirekt via ALU:n. Det går dock att
        läsa och skriva till \mono{F} via stacken med \mono{push af} och
        \mono{pop af}.
...
% flytta memory mapping hit från hw/ti/mem_ctrl? en del av ti83:ans funktionalitet och inte
% specifikt till vår implementation
