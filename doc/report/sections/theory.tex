...
\begin{itemize}
    ...
    \item \mono{PC} - Lagrar minnesplatsen som processorn tar instruktioner från. Inga
...
instruktionen är obestämd. \mono{IM 2} går att använda men eftersom databussen
